# THIS PYTHON FILE IS DOWNLOADED FROM https://github.com/elkebir-group/CloMu/pulls, A PULL REQUEST THAT SOLVES AN ISSUE WITH THE ORIGINAL CODE DEVELOPED BY STEFAN IVANOVIC AND EL-KEBIR, WHICH CAN BE DOWNLOADED FROM https://github.com/elkebir-group/CloMu
...
# IMPORT TQDM TO HAVE A COMPACT VIEW OF TRAINING PROCESS
...
def trainModelTree(newTrees, sampleInverse, treeLength, mutationCategory, M, maxM, fileSave=False, baselineSave=False, usePurity=False, adjustProbability=True, trainSet=False, unknownRoot=False, regularizeFactor=0.002, iterations='default', verbose=False):
    ...
    if verbose:
        ...
        # THE FOLLOWING TWO LINES WHERE OUTSIDE THIS IF BLOCK
    ...
    # ADDED TQDM TO DISPLAY IN A COMPACT WAY THE TRAINING PROCESS

    for iter in tqdm(range(0, iterMax), desc="Training", unit="epoch"):#301): #3000
        ...
        # ADDED CHECK ON VERBOSE SO NOT TO PRINT IF VERBOSE IS FALSE
